<template>
  ...
  <div class="space">
    ...
    <p>A sua privacidade é importante para nós. É política do Sport4All respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Sport4All, e outros sites que possuímos e operamos.</p>
    ...
    <h2>Política de Cookies Sport4All</h2>
